...
class BC_API ec_public : public ec_point
{
public:
    ...
    ec_public(
        const ec_uncompressed& uncompressed, bool compress = false) noexcept;
    ...
    friend std::ostream& operator<<(
        std::ostream& out, const ec_public& of) noexcept;
...
private:
    ...
    static ec_public from_point(
        const ec_uncompressed& point, bool compress) noexcept;
