...
class BC_API electrum : public electrum_v1
{
public:
    /// Seed prefix types.
    ...
    electrum(
        const data_chunk& entropy, seed_prefix prefix, language lexicon,
...
protected:
    ...
    static seed_prefix normalized_to_prefix(const string_list& words) noexcept;
