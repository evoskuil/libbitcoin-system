...
{
const context p2pkh{
    prefix::ext::p2pkh::main::btc, prefix::wit::main::btc,
    prefix::add::p2pkh::main::btc, prefix::wif::main::btc};
const context p2sh{
    prefix::ext::p2sh::main::btc, prefix::wit::main::btc,
    prefix::add::p2sh::main::btc, prefix::wif::main::btc};
} // namespace main
namespace test
{
const context p2pkh{
    prefix::ext::p2pkh::test::btc, prefix::wit::test::btc,
    prefix::add::p2pkh::test::btc, prefix::wif::test::btc};
const context p2sh{
    prefix::ext::p2sh::test::btc, prefix::wit::test::btc,
    prefix::add::p2sh::test::btc, prefix::wif::test::btc};
} // namespace test
} // namespace btc
namespace ltc
{
...
{
const context p2pkh{
    prefix::ext::p2pkh::main::ltc, prefix::wit::main::ltc,
    prefix::add::undefined, prefix::wif::undefined};
const context p2sh{
    prefix::ext::p2sh::main::ltc, prefix::wit::main::ltc,
    prefix::add::undefined, prefix::wif::undefined};
} // namespace main
namespace test
{
const context p2pkh{
    prefix::ext::p2pkh::test::ltc, prefix::wit::test::ltc,
    prefix::add::undefined, prefix::wif::undefined};
const context p2sh{
    prefix::ext::undefined, prefix::wit::test::ltc, prefix::add::undefined,
