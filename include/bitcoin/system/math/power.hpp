...
template <
    typename Exponent = size_t, typename Base, typename Value,
...
template <
    typename Exponent = size_t, typename Value, if_integer<Exponent> = true,
    if_integer<Value> = true>
...
template <
    typename Value = size_t, typename Base, typename Exponent,
...
template <
    typename Value = size_t, typename Exponent, if_integer<Value> = true,
    if_integer<Exponent> = true>
