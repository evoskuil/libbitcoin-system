...
public:
    ...
    static uint32_t minimum_timespan(
        uint32_t retargeting_interval_seconds,
        uint32_t retargeting_factor) noexcept;
    static uint32_t maximum_timespan(
        uint32_t retargeting_interval_seconds,
        uint32_t retargeting_factor) noexcept;
    static uint32_t retargeting_interval(
        uint32_t retargeting_interval_seconds,
...
protected:
    ...
    static activations activation(
        const data& values, uint32_t forks,
        const system::settings& settings) noexcept;
    static uint32_t median_time_past(
        const data& values, uint32_t forks) noexcept;
    static uint32_t work_required(
        const data& values, uint32_t forks,
        const system::settings& settings) noexcept;
...
private:
    ...
    static uint32_t work_required_retarget(
        const data& values, uint32_t forks, uint256_t work_limit,
