...
using if_base_of = enable_if_type<std::is_base_of<Base, Type>::value, bool>;
...
template <typename Type>
using if_integral_integer =
    enable_if_type<is_integer<Type>() && std::is_integral<Type>::value, bool>;

template <typename Type>
using if_non_integral_integer =
    enable_if_type<is_integer<Type>() && !std::is_integral<Type>::value, bool>;

template <typename Type>
using if_signed_integer =
    enable_if_type<is_integer<Type>() && std::is_signed<Type>::value, bool>;

template <typename Type>
using if_unsigned_integer =
    enable_if_type<is_integer<Type>() && !std::is_signed<Type>::value, bool>;
