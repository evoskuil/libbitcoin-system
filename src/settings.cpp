...
settings::settings() noexcept
    : retargeting_factor(4), retargeting_interval_seconds(2 * 7 * 24 * 60 * 60),
      block_spacing_seconds(10 * 60), timestamp_limit_seconds(2 * 60 * 60),
      proof_of_work_limit(0x1d00ffff), initial_subsidy_bitcoin(50),
      subsidy_interval_blocks(210000), genesis_block{}, first_version(1),
      bip34_version(2), bip66_version(3), bip65_version(4),
      bip9_version_bit0(1 << 0), bip9_version_bit1(1 << 1),
      bip9_version_base(0x20000000)
{
}

settings::settings(chain::selection context) noexcept : settings()
{
    switch (context)
    {
    case chain::selection::mainnet:
    {
        genesis_block = chain::block(
            {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             ...
             },
            false);
    ...
    case chain::selection::testnet:
    {
        genesis_block = chain::block(
            {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             ...
             0x7a, 0xc7, 0x2c, 0x3e, 0x67, 0x76, 0x8f, 0x61, 0x7f, 0xc8, 0x1b,
             0xc3, 0x88, 0x8a, 0x51, 0x32, 0x3a, 0x9f, 0xb8, 0xaa, 0x4b, 0x1e,
             0x5e, 0x4a, 0xda, 0xe5, 0x49, 0x4d, 0xff, 0xff, 0x00, 0x1d, 0x1a,
             0xa4, 0xae, 0x18, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
             0xff, 0x4d, 0x04, 0xff, 0xff, 0x00, 0x1d, 0x01, 0x04, 0x45, 0x54,
    ...
    case chain::selection::regtest:
    {
        ...
        genesis_block = chain::block(
            {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             ...
             0x7a, 0xc7, 0x2c, 0x3e, 0x67, 0x76, 0x8f, 0x61, 0x7f, 0xc8, 0x1b,
             0xc3, 0x88, 0x8a, 0x51, 0x32, 0x3a, 0x9f, 0xb8, 0xaa, 0x4b, 0x1e,
             0x5e, 0x4a, 0xda, 0xe5, 0x49, 0x4d, 0xff, 0xff, 0x7f, 0x20, 0x02,
             0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
             0xff, 0x4d, 0x04, 0xff, 0xff, 0x00, 0x1d, 0x01, 0x04, 0x45, 0x54,
...
{
    return chain::chain_state::minimum_timespan(
        retargeting_interval_seconds, retargeting_factor);
}

// The upper bound for the retargeting timespan.
uint32_t settings::maximum_timespan() const noexcept
{
    return chain::chain_state::maximum_timespan(
        retargeting_interval_seconds, retargeting_factor);
}
