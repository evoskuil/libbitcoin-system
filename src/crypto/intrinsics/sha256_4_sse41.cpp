...
__m128i inline K(uint32_t x) noexcept
{
    return _mm_set1_epi32(x);
}

__m128i inline Add(__m128i x, __m128i y) noexcept
{
    return _mm_add_epi32(x, y);
}
__m128i inline Add(__m128i x, __m128i y, __m128i z) noexcept
{
    return Add(Add(x, y), z);
}
__m128i inline Add(__m128i x, __m128i y, __m128i z, __m128i w) noexcept
{
    return Add(Add(x, y), Add(z, w));
}
__m128i inline Add(
    __m128i x, __m128i y, __m128i z, __m128i w, __m128i v) noexcept
{
    return Add(Add(x, y, z), Add(w, v));
}
__m128i inline Inc(__m128i& x, __m128i y) noexcept
{
    x = Add(x, y);
    return x;
}
__m128i inline Inc(__m128i& x, __m128i y, __m128i z) noexcept
{
    x = Add(x, y, z);
    return x;
}
__m128i inline Inc(__m128i& x, __m128i y, __m128i z, __m128i w) noexcept
{
    x = Add(x, y, z, w);
    return x;
}
__m128i inline Xor(__m128i x, __m128i y) noexcept
{
    return _mm_xor_si128(x, y);
}
__m128i inline Xor(__m128i x, __m128i y, __m128i z) noexcept
{
    return Xor(Xor(x, y), z);
}
__m128i inline Or(__m128i x, __m128i y) noexcept
{
    return _mm_or_si128(x, y);
}
__m128i inline And(__m128i x, __m128i y) noexcept
{
    return _mm_and_si128(x, y);
}
__m128i inline ShR(__m128i x, int n) noexcept
{
    return _mm_srli_epi32(x, n);
}
__m128i inline ShL(__m128i x, int n) noexcept
{
    return _mm_slli_epi32(x, n);
}

__m128i inline Ch(__m128i x, __m128i y, __m128i z) noexcept
{
    return Xor(z, And(x, Xor(y, z)));
}
__m128i inline Maj(__m128i x, __m128i y, __m128i z) noexcept
{
    return Or(And(x, y), And(z, Or(x, y)));
}
__m128i inline Sigma0(__m128i x) noexcept
{
    return Xor(
        Or(ShR(x, 2), ShL(x, 30)), Or(ShR(x, 13), ShL(x, 19)),
        Or(ShR(x, 22), ShL(x, 10)));
}
__m128i inline Sigma1(__m128i x) noexcept
{
    return Xor(
...
void inline Round(
    __m128i a, __m128i b, __m128i c, __m128i& d, __m128i e, __m128i f,
    __m128i g, __m128i& h, __m128i k) noexcept
{
