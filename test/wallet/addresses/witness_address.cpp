...
BOOST_AUTO_TEST_CASE(
    witness_address__string_construct__invalid_version_0__invalid)
{
    BOOST_REQUIRE(!witness_address(
...
BOOST_AUTO_TEST_CASE(
    witness_address__string_construct__invalid_version_0_lax__invalid)
{
    BOOST_REQUIRE(!witness_address(
        "split1checkupstagehandshakeupstreamerranterredcaperred2y9e3w", false));
}

BOOST_AUTO_TEST_CASE(
    witness_address__string_construct__valid_version_0_strict__valid)
{
    BOOST_REQUIRE(witness_address(
...
BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__minimal_program_abc_17__invalid)
{
    BOOST_REQUIRE(!witness_address(data_chunk(2, 0x00), "abc", 17));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__minimal_program_abc_16__valid)
{
    BOOST_REQUIRE(witness_address(data_chunk(2, 0x00), "abc", 16));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__maximal_program_abc_16__valid)
{
    BOOST_REQUIRE(witness_address(data_chunk(40, 0x00), "abc", 1));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__oversized_program_abc_16__valid)
{
    BOOST_REQUIRE(!witness_address(data_chunk(40 + 1, 0x00), "abc", 1));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__minimal_program_abc_1__valid)
{
    BOOST_REQUIRE(witness_address(data_chunk(2, 0x00), "abc", 1));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__minimal_program_abc_0__invalid)
{
    BOOST_REQUIRE(!witness_address(data_chunk(2, 0x00), "abc", 0));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__null_short_hash_abc_0__valid)
{
    BOOST_REQUIRE(witness_address(null_short_hash, "abc", 0));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__null_short_hash_invalid_prefix_0__invalid)
{
    BOOST_REQUIRE(!witness_address(null_short_hash, "\x80", 0));
}

BOOST_AUTO_TEST_CASE(
    witness_address__short_hash_construct__null_short_hash__valid)
{
    BOOST_REQUIRE(witness_address(null_short_hash));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__null_hash_abc_0__valid)
{
    BOOST_REQUIRE(witness_address(null_hash, "abc", 0));
}

BOOST_AUTO_TEST_CASE(
    witness_address__parameter_construct__null_hash_invalid_prefix_0__invalid)
{
...
BOOST_AUTO_TEST_CASE(
    witness_address__ec_private_construct__uninitialized__invalid)
{
...
{
    BOOST_REQUIRE(witness_address(
        ec_private("L1WepftUBemj6H4XQovkiW1ARVjxMqaw4oj2kmkYqdG1xTnBcHfC")));
}

BOOST_AUTO_TEST_CASE(
    witness_address__ec_public_construct__uninitialized__invalid)
{
...
{
    BOOST_REQUIRE(
        witness_address(script(script::to_pay_null_data_pattern(null_hash))));
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_prefix("\x80") == result::prefix_not_ascii);
    BOOST_REQUIRE(
        witness_address::parse_prefix("\xff") == result::prefix_not_ascii);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_prefix__upper_case__prefix_not_lower_case)
{
    BOOST_REQUIRE(
        witness_address::parse_prefix("A") == result::prefix_not_lower_case);
    BOOST_REQUIRE(
        witness_address::parse_prefix("aBc") == result::prefix_not_lower_case);
}

BOOST_AUTO_TEST_CASE(witness_address__parse_prefix__empty__prefix_too_short)
{
    BOOST_REQUIRE(
        witness_address::parse_prefix("") == result::prefix_too_short);
    BOOST_REQUIRE(
        witness_address::parse_prefix("\x00") == result::prefix_too_short);
}
...
BOOST_AUTO_TEST_CASE(witness_address__parse_prefix__upper_case__prefix_too_long)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_prefix(prefix) == result::prefix_too_long);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_prefix__invalid_ascii__prefix_invalid_character)
{
    // Only ascii characters will be captured here [0x00-0x20, 0x7f].
    BOOST_REQUIRE(
        witness_address::parse_prefix({0x00})
        == result::prefix_invalid_character);
    BOOST_REQUIRE(
        witness_address::parse_prefix("\x20")
        == result::prefix_invalid_character);
    BOOST_REQUIRE(
        witness_address::parse_prefix("\x7f")
        == result::prefix_invalid_character);
    BOOST_REQUIRE(
        witness_address::parse_prefix("z\x7fz")
        == result::prefix_invalid_character);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_prefix__valid_characters_and_lengths__valid)
{
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_prefix__unknown_strict__prefix_unknown)
{
    BOOST_REQUIRE(witness_address::parse_prefix("split") == result::valid);
    BOOST_REQUIRE(
        witness_address::parse_prefix("split", true) == result::prefix_unknown);
}

// parse_address

BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__not_ascii__address_not_ascii)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "\x80")
        == result::address_not_ascii);
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "\xff")
        == result::address_not_ascii);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__mixed_case__address_mixed_case)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "aBc")
        == result::address_mixed_case);
}
...
BOOST_AUTO_TEST_CASE(witness_address__parse_address__too_long__address_too_long)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, address)
        == result::address_too_long);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__no_separator__prefix_missing)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "abc")
...
BOOST_AUTO_TEST_CASE(witness_address__parse_address__separator__prefix_errors)
{
    const std::string prefix((90 - 1 - 1 - 4 - 6) + 1, 'a');
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "1")
        == result::prefix_too_short);
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, prefix + "1")
        == result::prefix_too_long);
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
            "\x7f"
            "1")
        == result::prefix_invalid_character);
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__short_payload__payload_too_short)
{
    const std::string payload((1 + 4 + 6) - 1, 'i');
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "a1" + payload)
        == result::payload_too_short);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__long_payload__payload_too_long)
{
    const std::string payload((1 + 64 + 6) + 1, 'a');
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "a1" + payload)
        == result::payload_too_long);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__invalid_payload__payload_not_base32)
{
    const std::string payload(1 + 4 + 6, 'i');
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "a1" + payload)
        == result::payload_not_base32);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__invalid_checksum__checksum_invalid)
{
    const std::string prefix{"bc"};
    auto address =
        prefix + "1"
        + encode_base32(bech32_build_checked(0, data_chunk(2, 0x00), prefix));
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__version_17__version_invalid)
{
    ...
    const auto address =
        prefix + "1"
        + encode_base32(bech32_build_checked(version, program, prefix));
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__version_16_minimal_program_strict__program_invalid)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, address, true)
        == result::program_invalid);
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, address, false)
        == result::valid);
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__version_0_empty_program__payload_too_short)
{
    const std::string prefix{"bc"};
    const auto address =
        prefix + "1" + encode_base32(bech32_build_checked(0, {}, prefix));
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__version_0_minimal_program__program_invalid)
{
    const std::string prefix{"bc"};
    const auto address =
        prefix + "1"
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__version_0_null_short_hash_program__valid)
{
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_address__version_0_null_hash_program__valid)
{
    const size_t version = 0;
...
BOOST_AUTO_TEST_CASE(
    witness_address__parse_program__version_0_short_hash_size__version_0_p2kh)
{
    BOOST_REQUIRE(
        witness_address::parse_program(0, null_short_hash)
        == type::version_0_p2kh);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_program__version_0_hash_size__version_0_p2sh)
{
    BOOST_REQUIRE(
        witness_address::parse_program(0, null_hash) == type::version_0_p2sh);
}

BOOST_AUTO_TEST_CASE(witness_address__parse_program__version_16_short__invalid)
{
    BOOST_REQUIRE(
        witness_address::parse_program(16, data_chunk(1, 0x00))
        == type::invalid);
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_program(16, data_chunk(40 + 1, 0x00))
        == type::invalid);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_program__version_non_zero_valid__unknown)
{
    BOOST_REQUIRE(
        witness_address::parse_program(1, null_hash) == type::unknown);
    BOOST_REQUIRE(
        witness_address::parse_program(16, null_hash) == type::unknown);
}

BOOST_AUTO_TEST_CASE(
    witness_address__parse_program__version_non_zero_valid_strict__invalid)
{
    BOOST_REQUIRE(
        witness_address::parse_program(1, null_hash, true) == type::invalid);
    BOOST_REQUIRE(
        witness_address::parse_program(16, null_hash, true) == type::invalid);
}

BOOST_AUTO_TEST_CASE(witness_address__parse_program__version_invalid__invalid)
{
    BOOST_REQUIRE(
        witness_address::parse_program(17, null_hash) == type::invalid);
    BOOST_REQUIRE(
        witness_address::parse_program(255, null_hash) == type::invalid);
}
...
BOOST_AUTO_TEST_CASE(witness_address__encoded__key_hash_prefix__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        instance.encoded(),
        "split1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqs8xlkk");
}
...
BOOST_AUTO_TEST_CASE(witness_address__encoded__ec_private__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        instance.encoded(), "bc1qkn8up7xm8564fea4rzrn6t6pcv6mk8atnna7pw");
}
...
BOOST_AUTO_TEST_CASE(witness_address__encoded__ec_private_prefix__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        instance.encoded(), "split1qkn8up7xm8564fea4rzrn6t6pcv6mk8atkw7e5r");
}
...
{
    const auto script =
        chain::script(script::to_pay_null_data_pattern(null_hash));
    const auto script_hash = sha256_hash(script.to_data(false));
    const witness_address instance{script_hash};
    BOOST_REQUIRE_EQUAL(
        instance.encoded(),
        "bc1qpxlkrchnvcz7exzzshh542797nzqx6g4vk5n4sn3m9sf64xlmarsp3t6g2");
}
...
BOOST_AUTO_TEST_CASE(witness_address__encoded__script_hash_prefix__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        instance.encoded(),
        "split1qpxlkrchnvcz7exzzshh542797nzqx6g4vk5n4sn3m9sf64xlmars6pd44m");
}
...
BOOST_AUTO_TEST_CASE(witness_address__script__version_16_address__valid)
{
    const witness_address instance{"bc1sqqqqkfw08p"};
    BOOST_REQUIRE(
        chain::script::is_pay_witness_pattern(instance.script().ops()));
}

BOOST_AUTO_TEST_CASE(witness_address__script__key_hash__pay_witness_key_hash)
{
    const witness_address instance{null_short_hash};
    BOOST_REQUIRE(chain::script::is_pay_witness_key_hash_pattern(
        instance.script().ops()));
}

BOOST_AUTO_TEST_CASE(
    witness_address__script__script_hash__pay_witness_script_hash)
{
    const witness_address instance{null_hash};
    BOOST_REQUIRE(chain::script::is_pay_witness_script_hash_pattern(
        instance.script().ops()));
}

BOOST_AUTO_TEST_CASE(
    witness_address__script__null_data_script__pay_witness_script_hash)
{
    const auto script =
        chain::script(script::to_pay_null_data_pattern(null_hash));
    const witness_address instance{script};
...
{
    const witness_address instance1{
        "bc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq9e75rs"};
    const witness_address instance2{
        "bc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq9e75rs"};
...
{
    const witness_address instance1{
        "bc1qkn8up7xm8564fea4rzrn6t6pcv6mk8atnna7pw"};
    const witness_address instance2{
        "bc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq9e75rs"};
...
BOOST_AUTO_TEST_CASE(
    witness_address__istream__invalid__throws_istream_exception)
{
    std::stringstream in{};
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__unversioned_empty_bech32_vectors__payload_too_short)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "A12UEL5L")
        == result::payload_too_short);
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "a12uel5l")
        == result::payload_too_short);
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "?1ezyfcl")
        == result::payload_too_short);
}
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__unversioned_empty_bech32_vectors__prefix_too_long)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
            "an83characterlonghumanreadablepartthatcontainsthenumber1andtheexcl"
            "udedcharactersbio1tt5tgs")
        == result::prefix_too_long);
}
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__unversioned_bech32_vectors__payload_too_long)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
            "11qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"
            "qqqqqqqqqqqqqqqqqqc8247j")
        == result::payload_too_long);
}

// This example of valid "bech32" can be interepreted as versioned or otherwise.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__unversioned_bech32_vectors__checksum_invalid)
{
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_bech32_prefix_character__invalid_expected)
{
    BOOST_REQUIRE(
        witness_address::parse_prefix("\x20")
        == result::prefix_invalid_character);
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_bech32_overall_length__address_too_long)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
            "an84characterslonghumanreadablepartthatcontainsthenumber1andtheexc"
            "ludedcharactersbio1569pvx")
        == result::address_too_long);
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "pzry9x0s0muk")
        == result::prefix_missing);
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "1pzry9x0s0muk")
        == result::prefix_too_short);
}

// Invalid data character.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_base32__payload_not_base32)
{
    // This example is too short to be a valid address test (requires 13 characters minimum).
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "x1b4n0q5v")
        == result::payload_too_short);
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "x1b4n00000q5v")
        == result::payload_not_base32);
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "li1dgmt3")
        == result::payload_too_short);
}

// 0xFF: Invalid character in checksum.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_checksum__payload_not_base32)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_checksum__payload_too_short)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "A1G7SGD8")
        == result::payload_too_short);
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "10a06t8")
        == result::prefix_too_short);
}
...
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "1qzzfhee")
        == result::prefix_too_short);
}
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__valid_address1__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        address.program(),
        base16_chunk("751e76e8199196d454941c45d1b3a323f1433bd6"));
    BOOST_REQUIRE_EQUAL(
        address.script().to_string(chain::all_rules),
        "zero [751e76e8199196d454941c45d1b3a323f1433bd6]");
}

BOOST_AUTO_TEST_CASE(witness_address__bip173__valid_address2__expected)
{
    const witness_address address(
        "tb1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q0sl5k7");
    BOOST_REQUIRE_EQUAL(address.version(), 0u);
    BOOST_REQUIRE(address.identifier() == type::version_0_p2sh);
    BOOST_REQUIRE_EQUAL(
        address.program(), base16_chunk("1863143c14c5166804bd19203356da136c9856"
                                        "78cd4d27a1b8c6329604903262"));
    BOOST_REQUIRE_EQUAL(
        address.script().to_string(chain::all_rules),
        "zero "
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__valid_address3__expected)
{
    ...
    const auto program =
        base16_array("751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d45"
                     "4941c45d1b3a323f1433bd6");
    const witness_address address(program, "bc", 1);
    BOOST_REQUIRE_EQUAL(
        address.encoded(), "bc1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y"
                           "5r3zarvary0c5xw7kt5nd6y");
    ...
    BOOST_REQUIRE_EQUAL(
        address.script().to_string(chain::all_rules),
        "1 "
        "[751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a"
        "323f1433bd6]");
}
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__valid_address4__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(address.program(), to_chunk(program));
    BOOST_REQUIRE_EQUAL(
        address.script().to_string(chain::all_rules), "16 [751e]");
}
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__valid_address5__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        address.encoded(), "bc1zw508d6qejxtdg4y5r3zarvaryvaxxpcs");
    BOOST_REQUIRE_EQUAL(address.version(), 2u);
    BOOST_REQUIRE(address.identifier() == type::unknown);
    BOOST_REQUIRE_EQUAL(address.program(), to_chunk(program));
    BOOST_REQUIRE_EQUAL(
        address.script().to_string(chain::all_rules),
        "2 [751e76e8199196d454941c45d1b3a323]");
}
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__valid_address6__expected)
{
    ...
    BOOST_REQUIRE(address.identifier() == type::version_0_p2sh);
    BOOST_REQUIRE_EQUAL(
        address.program(), base16_chunk("000000c4a5cad46221b2a187905e5266362b99"
                                        "d5e91c6ce24d165dab93e86433"));
    BOOST_REQUIRE_EQUAL(
        address.script().to_string(chain::all_rules),
        "zero "
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__invalid_address1__prefix_unknown)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "tc1qw508d6qejxtdg4y5r3zarvary0c5xw7kg3g4ty")
        == result::valid);
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "tc1qw508d6qejxtdg4y5r3zarvary0c5xw7kg3g4ty",
            true)
        == result::prefix_unknown);
}

// Invalid checksum.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address2__checksum_invalid)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t5")
        == result::checksum_invalid);
}

// Invalid witness version.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address3__checksum_invalid)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "BC13W508D6QEJXTDG4Y5R3ZARVARY0C5XW7KN40WF2")
        == result::checksum_invalid);
}

// Invalid program length.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address4__payload_too_short)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "bc1rw5uspcuh")
        == result::payload_too_short);
}

// Invalid program length.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address5__payload_too_long)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
            "bc10w508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw"
            "7kw5rljs90")
        == result::payload_too_long);
}
...
BOOST_AUTO_TEST_CASE(witness_address__bip173__invalid_address6__program_invalid)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "BC1QR508D6QEJXTDG4Y5R3ZARVARYV98GJ9P")
        == result::program_invalid);
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "BC1QR508D6QEJXTDG4Y5R3ZARVARYV98GJ9P", true)
        == result::program_invalid);
}

// Mixed case.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address7__address_mixed_case)
{
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3,
...
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address8__checksum_invalid)
{
    ...
    BOOST_REQUIRE(
        witness_address::parse_address(
            out1, out2, out3, "bc1zw508d6qejxtdg4y5r3zarvaryvqyzf3du")
        == result::checksum_invalid);
}
...
// Empty data section.
BOOST_AUTO_TEST_CASE(
    witness_address__bip173__invalid_address10__payload_too_short)
{
    BOOST_REQUIRE(
        witness_address::parse_address(out1, out2, out3, "bc1gmk9yu")
        == result::payload_too_short);
}
