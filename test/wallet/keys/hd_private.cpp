...
BOOST_AUTO_TEST_CASE(hd_private__derive_private__short_seed__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        m.encoded(), "xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPq"
...
BOOST_AUTO_TEST_CASE(hd_private__derive_private__long_seed__expected)
{
    ...
    const auto m0xH1yH =
        m0xH1.derive_private(2147483646 + hd_first_hardened_key);
    const auto m0xH1yH2 = m0xH1yH.derive_private(2);

    BOOST_REQUIRE_EQUAL(
        m.encoded(), "xprv9s21ZrQH143K31xYSDQpPDxsXRTUcvj2iNHm5NUtrGiGG5e2DtALG"
                     "dso3pGz6ssrdK4PFmM8NSpSBHNqPqm55Qn3LqFtT2emdEXVYsCzC2U");
    BOOST_REQUIRE_EQUAL(
        m0.encoded(),
...
BOOST_AUTO_TEST_CASE(hd_private__derive_public__long_seed__expected)
{
    ...
    const auto m0xH1yH_pub =
        m0xH1.derive_public(2147483646 + hd_first_hardened_key);
