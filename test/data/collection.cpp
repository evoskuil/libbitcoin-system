...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_native__one_element_unmatched__not_found)
{
...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_native__three_elements_match_second__1)
{
...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_native__reverse_sorted_contained__unlucky)
{
...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_element__three_various_elements_unmatched__not_found)
{
...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_element__three_various_elements_matched__found)
{
    const string_list sorted{"afgdjdfj", "btffghfg", "cfdd"};
...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_key__three_various_elements_unmatched__not_found)
{
...
BOOST_AUTO_TEST_CASE(
    limits__binary_search_key__three_various_elements_matched__found)
{
    const std::vector<const char*> sorted{"afgdjdfj", "btffghfg", "cfdd"};
...
BOOST_AUTO_TEST_CASE(
    collection__distinct__distinct_unsorted_duplicates__sorted_distinct)
{
...
BOOST_AUTO_TEST_CASE(
    collection__distinct_copy__distinct_unsorted_duplicates__sorted_distinct)
{
