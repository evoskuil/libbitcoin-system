...
#define CONFIG_PRINTER_SETUP_ARGUMENTS(initializer)                            \
    ...
    initializer;                                                               \
    printer help(                                                              \
        options, arguments, CONFIG_APPLICATION, CONFIG_DESCRIPTION,            \
        CONFIG_COMMAND)
...
BOOST_AUTO_TEST_CASE(
    printer__columnize__middle_word_overflow_width_10__three_rows)
{
    CONFIG_PRINTER_SETUP();
...
BOOST_AUTO_TEST_CASE(
    printer__columnize__excess_whitespace_width_10__space_removed)
{
    CONFIG_PRINTER_SETUP();
    auto rows =
        help.columnize("  \tfoo   bar \n\n  morethantenchars\r\n  ", 10);
    BOOST_REQUIRE_EQUAL(rows.size(), 3u);
    BOOST_REQUIRE_EQUAL(rows[0], "\tfoo bar");
...
BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__named_three_options__three_options)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("long", "Long name only.")(
            ",m", "Short name only.")("short_long,s", "Long and short name."));
    CONFIG_PRINTER_INITIALIZE(3u, 0u);
    BOOST_REQUIRE_EQUAL(
        help.format_parameters_table(false),
        "--long               Long name only.                                  "
        "   \n"
        "-m                   Short name only.                                 "
        "   \n"
...
BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__reversed_named_three_options__three_sorted_options)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("short_long,s", "Long and short name.")(
            ",m", "Short name only.")("long", "Long name only."));
    CONFIG_PRINTER_INITIALIZE(3u, 0u);
    BOOST_REQUIRE_EQUAL(
        help.format_parameters_table(false),
        "--long               Long name only.                                  "
...
BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__unsorted_named_three_options_no_matching_arguments__three_sorted_options)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("first,f", "First option description.")(
            "second,x",
            "Second option description.")("third", "Third option description.");
        arguments.add("forty-two", 42); arguments.add("THIRD", -1));
...
BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__named_three_options_two_matching_arguments__one_option)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("first,f", "First option description.")(
            "second,x",
            "Second option description.")("THIRD", "Third option description.");
        arguments.add("FIRST", 1); arguments.add("second", 42);
...
BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__positional_three_options__empty)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("long", "Long name only.")(
            "short_long,s", "Long and short name.")(",m", "Short name only."));
    CONFIG_PRINTER_INITIALIZE(3u, 0u);
    BOOST_REQUIRE_EQUAL(help.format_parameters_table(true), "");
}

BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__positional_three_options_one_matching_argument__one_argument)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("first,f", "First option description.")(
            "second,x",
    ...
    CONFIG_PRINTER_INITIALIZE(3u, 3u);
    BOOST_REQUIRE_EQUAL(
        help.format_parameters_table(true),
        "THIRD                Third option description.                        "
        "   \n");
}

BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__reverse_positional_three_options_three_matching_arguments__three_unsorted_arguments)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("third", "Third option description.")(
            "SECOND",
            "Second option description.")("FIRST", "First option description.");
        arguments.add("FIRST", 1); arguments.add("SECOND", 42);
        arguments.add("third", -1));
    CONFIG_PRINTER_INITIALIZE(3u, 3u);
    BOOST_REQUIRE_EQUAL(
...
BOOST_AUTO_TEST_CASE(
    printer__format_parameters_table__positional_three_options_two_matching_arguments_overflow__two_arguments_overflow)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("first,f", "First option description.")(
            "SECOND,x",
    ...
    BOOST_REQUIRE_EQUAL(
        table, "SECOND               Lorem ipsum dolor sit amet, consectetur "
               "adipiscing  \n"
...
BOOST_AUTO_TEST_CASE(
    printer__format_usage_parameters__unsorted_two_options_one_arg__sorted)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("second,x", "Second option description.")(
            "first,f",
            "First option description.")("THIRD", "Third option description.");
        arguments.add("FIRST", 1); arguments.add("SECOND", 42);
        arguments.add("THIRD", -1));
    CONFIG_PRINTER_INITIALIZE(3u, 3u);
...
BOOST_AUTO_TEST_CASE(
    printer__format_usage_parameters__unsorted_multiple_parameters__sorted_parameters)
{
    using namespace boost::filesystem;
    using namespace boost::program_options;
    CONFIG_PRINTER_SETUP_ARGUMENTS(options.add_options()(
        "short_long,s", "Long and short name.")(",m", "Short name only.")(
        "longy", value<int>()->required(),
        ...
        "toggled,t", value<bool>()->zero_tokens(),
        "Toggled, zero token and short.")(
    ...
    BOOST_REQUIRE_EQUAL(
        help.format_usage_parameters(),
        "[-mst] --longy value [--untoggled] [--defaulty value] [--multy "
        "value]... REQUIRED [SIMPLE] [ARRAY]...");
}
BOOST_AUTO_TEST_SUITE_END()
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__empty_arguments_empty_options__empty)
{
    CONFIG_PRINTER_SETUP();
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__empty_arguments_multiple_options__empty)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("long", "Long name only.")(
            "short_long,s", "Long and short name.")(",m", "Short name only."));
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__one_argument_1__one_name_1)
{
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__one_argument_42__one_name_42)
{
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__one_argument_max_arguments__one_name_max_arguments)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__one_argument_max_arguments_plus_1__one_name_negative_1)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        arguments.add("max_arguments+1", printer::max_arguments + 1));
    BX_PRINTER_GENERATE_ARGUMENT_NAMES(1u);
    const auto& names = help.get_argument_names();
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__one_argument_negative_1__one_name_negative_1)
{
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__multiple_arguments__expected_names)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
...
BOOST_AUTO_TEST_CASE(
    printer__generate_argument_names__multiple_arguments_negative_1__expected_names)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        arguments.add("forty-two", 42);
        arguments.add("max_arguments", printer::max_arguments);
...
BOOST_AUTO_TEST_CASE(
    printer__generate_parameters__one_option__expected_parameter)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("foo_bar,f", "Foobar option name."));
...
BOOST_AUTO_TEST_CASE(
    printer__generate_parameters__unsorted_three_options__expected_sorted_parameters)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("first,f", "First option description.")(
    ...
    BOOST_REQUIRE_EQUAL(
        parameters[2].description(), "Second option description.");
}
...
BOOST_AUTO_TEST_CASE(
    printer__initialize__unsorted_multitple_options__expected_sorted_parameters)
{
    CONFIG_PRINTER_SETUP_ARGUMENTS(
        options.add_options()("first,f", "First option description.")(
            "second,x",
            "Second option description.")("third", "Third option description.");
        arguments.add("forty-two", 42); arguments.add("negative-one", -1));
    CONFIG_PRINTER_INITIALIZE(3u, 2u);
    const auto& names = help.get_argument_names();
    const auto& parameters = help.get_parameters();
    BOOST_REQUIRE_EQUAL(names[0].first, "forty-two");
