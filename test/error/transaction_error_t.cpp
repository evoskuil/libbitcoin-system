...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_success__false_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__empty_transaction__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__previous_output_null__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__spend_overflow__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__invalid_coinbase_script_size__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__coinbase_transaction__true_exected_message)
{
    ...
    BOOST_REQUIRE(ec == value);
    BOOST_REQUIRE_EQUAL(
        ec.message(), "coinbase transaction disallowed in memory pool");
}

BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_internal_double_spend_true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_size_limit__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_legacy_sigop_limit__true_exected_message)
{
    ...
    BOOST_REQUIRE(ec == value);
    BOOST_REQUIRE_EQUAL(
        ec.message(), "too many transaction legacy signature operations");
}

// accept transaction

BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__unexpected_witness_transaction__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_non_final__true_exected_message)
{
    ...
    BOOST_REQUIRE(ec == value);
    BOOST_REQUIRE_EQUAL(
        ec.message(), "transaction currently non-final for next block");
}

BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__premature_validation__true_exected_message)
{
    ...
    BOOST_REQUIRE(ec == value);
    BOOST_REQUIRE_EQUAL(
        ec.message(), "transaction validation under checkpoint");
}

BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__unspent_duplicate__true_exected_message)
{
    ...
    BOOST_REQUIRE(ec == value);
    BOOST_REQUIRE_EQUAL(
        ec.message(), "matching transaction with unspent outputs");
}

BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__missing_previous_output_true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__double_spend__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__coinbase_maturity__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__spend_exceeds_value__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_sigop_limit__true_exected_message)
{
    ...
    BOOST_REQUIRE(ec == value);
    BOOST_REQUIRE_EQUAL(
        ec.message(), "too many transaction embedded signature operations");
}

BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__relative_time_locked__true_exected_message)
{
...
BOOST_AUTO_TEST_CASE(
    transaction_error_t__code__transaction_weight_limit__true_exected_message)
{
