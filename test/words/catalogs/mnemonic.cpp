...
const auto identity_es = base16_array(
    "27e99ad4328299108663c19eb611310bd3b77260af852169108713019831d07d");
const auto identity_it = base16_array(
    "d9664953fe4c49e0b40eb6f6378c421f5f01dc9360aaac6d2a3c294f046ef520");
const auto identity_fr = base16_array(
    "fd4cd57c8e86a99ac53cd0f21a6b89af366769b0143ac0d268ac7d7a39200145");
const auto identity_cs = base16_array(
    "92e035ca0e3680fab85fa18b9e5c7e7582b3bd9caeb6d4bc8a2ecc8e492100c9");
const auto identity_pt = base16_array(
    "85fea658f90c42c182823807a1d30db587abb72c14a3098e1a65f8b78d1ffcf4");
const auto identity_ja = base16_array(
    "e641781d89213031233ebc5130020c3de297cad96065ecc688d1c00e010ea71c");
const auto identity_ko = base16_array(
    "0c26059ed7ede977d7fa1c40443e71793e7850aa6a3d8aabf0cbcec91c1f95ec");
const auto identity_zh_Hans = base16_array(
    "a86e2bd870e228d19a887c9faae8c1374b4e624e85d2b245b59e36583cba4afc");
const auto identity_zh_Hant = base16_array(
    "11ef479f2f44b6d4f7fb6239dff06e3cd7a1473b83df6cf91adcbbbee598acf6");
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__count__all__expected)
{
    ...
    BOOST_REQUIRE_MESSAGE(
        mnemonic::catalogs::count() == dictionary_count, "new dictionary");
}
...
{
    BOOST_REQUIRE_EQUAL(
        deviation(mnemonic::en, mnemonic::fr), deviations_en_fr);
    BOOST_REQUIRE_EQUAL(
        deviation(mnemonic::zh_Hans, mnemonic::zh_Hant), deviations_zh);
}
...
{
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::en, mnemonic::en), dictionary_size);
    BOOST_REQUIRE(!intersects(mnemonic::en, mnemonic::es));
    BOOST_REQUIRE(!intersects(mnemonic::en, mnemonic::it));
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::en, mnemonic::fr), intersecton_en_fr);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__es__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::es, mnemonic::es), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__it__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::it, mnemonic::it), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__fr__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::fr, mnemonic::fr), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__cs__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::cs, mnemonic::cs), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__pt__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::pt, mnemonic::pt), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__ja__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::ja, mnemonic::ja), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__ko__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::ko, mnemonic::ko), dictionary_size);
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__zh_Hans__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::zh_Hans, mnemonic::zh_Hans), dictionary_size);
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::zh_Hans, mnemonic::zh_Hant), intersection_zh);
}
...
BOOST_AUTO_TEST_CASE(catalogs_mnemonic__intersections__zh_Hant__expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        intersection(mnemonic::zh_Hant, mnemonic::zh_Hant), dictionary_size);
}
