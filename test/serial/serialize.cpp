...
BOOST_AUTO_TEST_CASE(
    string__array__string_empty__text_delimited_default_fallback)
{
    const std::array<const char*, 3> value{{"foo", "", "bar"}};
    BOOST_REQUIRE_EQUAL(serialize(value), "foo ? bar");
}
...
BOOST_AUTO_TEST_CASE(
    string__array__string_fallback__text_delimited_specified_fallback)
{
    const std::array<const char*, 3> value{{"foo", "", "bar"}};
    BOOST_REQUIRE_EQUAL(serialize(value, "*"), "foo * bar");
}
...
BOOST_AUTO_TEST_CASE(
    string__vector__string_empty__text_delimited_default_fallback)
{
    const std::vector<const char*> value{"foo", "", "bar"};
    BOOST_REQUIRE_EQUAL(serialize(value), "foo ? bar");
}
...
BOOST_AUTO_TEST_CASE(
    string__vector__string_fallback__text_delimited_specified_fallback)
{
    const std::vector<const char*> value{"foo", "", "bar"};
    BOOST_REQUIRE_EQUAL(serialize(value, "*"), "foo * bar");
}
