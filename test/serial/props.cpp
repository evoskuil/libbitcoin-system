...
BOOST_AUTO_TEST_CASE(props__write__array_xml__valid_expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        stream.str(),
        "<child>0</child><child>1</child><child>2</child><child>3</child>");
}
...
{
    std::ostringstream stream;
    object_props instance({{"child0", {0}}, {"child1", {1}}});
    instance.add({{"child2", {2}}, {"child3", {3}}});
    instance.write(stream, props::format::json);
    BOOST_REQUIRE(stream);
    BOOST_REQUIRE_EQUAL(
        stream.str(), "{\"child0\":0,\"child1\":1,\"child2\":2,\"child3\":3}");
}
...
BOOST_AUTO_TEST_CASE(props__write__object_xml__valid_expected)
{
    ...
    BOOST_REQUIRE(stream);
    BOOST_REQUIRE_EQUAL(
        stream.str(), "<child0>0</child0><child1>1</child1><child2>2</"
                      "child2><child3>3</child3>");
}
...
BOOST_AUTO_TEST_CASE(props__write__complex_object_json_flat__valid_expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        stream.str(),
        "{\"month\":{\"year\":2021,\"sundays\":[4,11,18,25],\"mondays\":[5,12,"
        "19,26],\"tuesdays\":[6,13,20,27],\"wednesdays\":[7,14,21,28],"
        "\"thursdays\":[1,8,15,22,29],\"fridays\":[2,9,16,23,30],\"saturdays\":"
        "[3,10,17,24,31]}}");
}
...
BOOST_AUTO_TEST_CASE(props__write__complex_object_info_flat__valid_expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        stream.str(),
        "{month {year 2021,sundays {4 11 18 25},mondays {5 12 19 26},tuesdays "
        "{6 13 20 27},wednesdays {7 14 21 28},thursdays {1 8 15 22 29},fridays "
        "{2 9 16 23 30},saturdays {3 10 17 24 31}}}");
}
...
BOOST_AUTO_TEST_CASE(props__write__complex_object_xml_flat__valid_expected)
{
    ...
    BOOST_REQUIRE_EQUAL(
        stream.str(),
        "<month><year>2021</year><sundays><sunday>4</sunday><sunday>11</"
        "sunday><sunday>18</sunday><sunday>25</sunday></"
        "sundays><mondays><monday>5</monday><monday>12</monday><monday>19</"
        "monday><monday>26</monday></mondays><tuesdays><tuesday>6</"
        "tuesday><tuesday>13</tuesday><tuesday>20</tuesday><tuesday>27</"
        "tuesday></tuesdays><wednesdays><wednesday>7</wednesday><wednesday>14</"
        "wednesday><wednesday>21</wednesday><wednesday>28</wednesday></"
        "wednesdays><thursdays><thursday>1</thursday><thursday>8</"
        "thursday><thursday>15</thursday><thursday>22</thursday><thursday>29</"
        "thursday></thursdays><fridays><friday>2</friday><friday>9</"
        "friday><friday>16</friday><friday>23</friday><friday>30</friday></"
        "fridays><saturdays><saturday>3</saturday><saturday>10</"
        "saturday><saturday>17</saturday><saturday>24</saturday><saturday>31</"
        "saturday></saturdays></month>");
}
