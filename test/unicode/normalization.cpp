...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_composition__bip38__expected)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_decomposition__bip38__expected)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_canonical_decomposition__non_ascii__false)
{
    std::string non_ascii{char(0xff)};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_composition__non_ascii__false)
{
    std::string non_ascii{char(0xff)};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_decomposition__non_ascii__false)
{
    std::string non_ascii{char(0xff)};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_canonical_decomposition__ascii__unchanged)
{
    std::string value{"abc"};
    const auto expected = value;
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_composition__ascii__unchanged)
{
    std::string value{"abc"};
    const auto expected = value;
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_decomposition__empty__empty)
{
    std::string empty{""};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compatibility_decomposition__ascii__unchanged)
{
    std::string value{"abc"};
    const auto expected = value;
...
#ifdef WITH_ICU
BOOST_AUTO_TEST_CASE(
    dictionaries_mnemonic__normalize__ideographic_space_sentence__ascii_space)
{
    // The ideographic_space normalizes to ascii_space.
    const auto ascii_delimited = "あいこくしん" + ascii_space + "あいさつ";
    const auto ideographic_delimited =
        "あいこくしん" + ideographic_space + "あいさつ";
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_combining_form__ascii_only__unchanged)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_combining_form__combining_circumflex_accent_only__empty)
{
    const std::u32string combining_circumflex_accent{0x00000302};
    BOOST_REQUIRE(
        to_non_combining_form(to_utf8(combining_circumflex_accent)).empty());
}

BOOST_AUTO_TEST_CASE(
    normalization__to_non_combining_form__bassa_vah_tones_only__empty)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_combining_form__bassa_vah_tones_combining_circumflex_accent_sandwich__empty)
{
    const std::u32string bassa_vah_sandwich{
        0x00000302, 0x00016af1, 0x00016af2, 0x00016af3, 0x00000302};
    BOOST_REQUIRE(to_non_combining_form(to_utf8(bassa_vah_sandwich)).empty());
}

BOOST_AUTO_TEST_CASE(
    normalization__to_non_combining_form__combining_circumflex_accent_and_ascii_mix__stripped)
{
    const std::string expected{0x42, 0x43, 0x44};
    const std::u32string bassa_vah{0x00000302, 0x42, 0x43,      0x00000302,
                                   0x00000302, 0x44, 0x00000302};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_diacritic_form__ascii_only__unchanged)
{
    const std::string expected{0x42, 0x43};
    const std::u32string ascii{0x42, 0x43};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_diacritic_form__circumflex_accent_only__empty)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_diacritic_form__bassa_vah_tones_only__empty)
{
    const std::u32string bassa_vah{0x00016af1, 0x00016af2, 0x00016af3};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_non_diacritic_form__bassa_vah_tones_ascii_sandwich__stripped)
{
    const std::string expected{0x42, 0x43};
    const std::u32string bassa_vah{
        0x42, 0x00016af1, 0x00016af2, 0x00016af3, 0x43};
    BOOST_REQUIRE_EQUAL(to_non_diacritic_form(to_utf8(bassa_vah)), expected);
}

BOOST_AUTO_TEST_CASE(
    normalization__to_non_diacritic_form__circumflex_accent_and_bassa_vah_tones_and_ascii_mix__stripped)
{
    const std::string expected{0x42, 0x43, 0x44};
    const std::u32string bassa_vah{0x00016af1, 0x42, 0x43,      0x0000005e,
                                   0x00016af2, 0x44, 0x00016af3};
    BOOST_REQUIRE_EQUAL(to_non_diacritic_form(to_utf8(bassa_vah)), expected);
}
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_form__ascii_single_spaced__unchanged)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_form__ascii_whitespaced__normalized)
{
    const auto value = "foo bar\tbaz";
    const auto result = to_compressed_form(value);
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_form__ascii_uncompressed_whitespace__normalized)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_form__ascii_spaces_and_ideographic_space__ideographic_space_unchanged)
{
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__cjk_unified_ideograph_only__unchanged)
{
    const std::u32string cjk_unified_ideograph{0x00004e00};
    const auto utf8 = to_utf8(cjk_unified_ideograph);
    BOOST_REQUIRE_EQUAL(
        to_compressed_form(to_utf8(cjk_unified_ideograph)), utf8);
}

BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__cjk_unified_ideograph_sandwich__stripped)
{
    const std::u32string expected{0x00004e00, 0x00004e00};
    const std::u32string cjk_unified_ideograph_sandwich{
        0x00004e00, 0x20, 0x00004e00};
    BOOST_REQUIRE_EQUAL(
        to_compressed_form(to_utf8(cjk_unified_ideograph_sandwich)),
        to_utf8(expected));
}

BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__cjk_unified_ideograph_right__ascii_space_space_trimmed)
{
    const std::u32string expected{0x00004e00, 0x00004e00};
    const std::u32string cjk_unified_ideograph_right{
        0x20, 0x00004e00, 0x00004e00};
...
BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__cjk_unified_ideograph_left__ascii_space_space_trimmed)
{
    const std::u32string expected{0x00004e00, 0x00004e00};
    const std::u32string cjk_unified_ideograph_left{
        0x00004e00, 0x00004e00, 0x20};
    BOOST_REQUIRE_EQUAL(
        to_compressed_form(to_utf8(cjk_unified_ideograph_left)),
        to_utf8(expected));
}

BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__cjk_unified_ideograph_both__ascii_space_spaces_trimmed)
{
    const std::u32string expected{0x00004e00, 0x00004e00};
    const std::u32string cjk_unified_ideograph_both{
        0x20, 0x00004e00, 0x00004e00, 0x20};
    BOOST_REQUIRE_EQUAL(
        to_compressed_form(to_utf8(cjk_unified_ideograph_both)),
        to_utf8(expected));
}

BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__cjk_unified_ideograph_all__stripped_and_trimmed)
{
    const std::u32string expected{0x00004e00, 0x00004e00};
    const std::u32string cjk_unified_ideograph_all{
        0x20, 0x00004e00, 0x0c, 0x00004e00, 0x20};
    BOOST_REQUIRE_EQUAL(
        to_compressed_form(to_utf8(cjk_unified_ideograph_all)),
        to_utf8(expected));
}

BOOST_AUTO_TEST_CASE(
    normalization__to_compressed_cjk__single_and_double_contained_whitespace__stripped_trimmed)
{
    const std::u32string expected{
        0x00004e00, 0x00004e00, 0x00004e00, 0x00004e00, 0x00004e00, 0x00004e00,
        0x00004e00, 0x00004e00, 0x00004e00, 0x00004e00, 0x00004e00, 0x00004e00};
    const std::u32string single_and_double_contained{
        0x20,       0x00004e00, 0x20,       0x00004e00, 0x20,       0x20,
        0x00004e00, 0x0c,       0x00004e00, 0x20,       0x20,       0x00004e00,
        0x0a,       0x00004e00, 0x20,       0x20,       0x00004e00, 0x0d,
        0x00004e00, 0x20,       0x20,       0x00004e00, 0x09,       0x00004e00,
        0x20,       0x20,       0x00004e00, 0x0b,       0x00004e00, 0x20};
...
BOOST_AUTO_TEST_CASE(
    normalization__is_chinese_japanese_or_korean__points__90286)
{
    size_t points = 0;
    for (uint32_t character = 0; character < maximum_code_point; ++character)
...
BOOST_AUTO_TEST_CASE(normalization__is_combining__is_diacritic__608_differences)
{
    ...
    BOOST_REQUIRE_EQUAL(
        ...
        "94 96 168 175 180 183 184 688 689 690 691 692 693 694 695 696 697 698 "
        "699 700 701 702 703 704 705 706 707 708 709 710 711 712 713 714 715 "
