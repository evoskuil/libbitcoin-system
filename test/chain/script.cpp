...
static const std::string script_return_80 =
    "return "
    "[0001020304050607080900010203040506070809000102030405060708090001020304050"
    "60708090001020304050607080900010203040506070809000102030405060708090001020"
    "3040506070809]";
static const std::string script_return_81 =
    "return "
    "[0001020304050607080900010203040506070809000102030405060708090001020304050"
    "60708090001020304050607080900010203040506070809000102030405060708090001020"
    "3040506070809FF]";

static const std::string script_0_of_3_multisig =
    "0 [03dcfd9e580de35d8c2060d76dbf9e5561fe20febd2e64380e860a4d59f15ac864] "
    "[02440e0304bf8d32b2012994393c6a477acf238dd6adb4c3cef5bfa72f30c9861c] "
    "[03624505c6cc3967352cce480d8550490dd68519cd019066a4c302fdfb7d1c9934] 3 "
    "checkmultisig";
static const std::string script_1_of_3_multisig =
    "1 [03dcfd9e580de35d8c2060d76dbf9e5561fe20febd2e64380e860a4d59f15ac864] "
    "[02440e0304bf8d32b2012994393c6a477acf238dd6adb4c3cef5bfa72f30c9861c] "
    "[03624505c6cc3967352cce480d8550490dd68519cd019066a4c302fdfb7d1c9934] 3 "
    "checkmultisig";
static const std::string script_2_of_3_multisig =
    "2 [03dcfd9e580de35d8c2060d76dbf9e5561fe20febd2e64380e860a4d59f15ac864] "
    "[02440e0304bf8d32b2012994393c6a477acf238dd6adb4c3cef5bfa72f30c9861c] "
    "[03624505c6cc3967352cce480d8550490dd68519cd019066a4c302fdfb7d1c9934] 3 "
    "checkmultisig";
static const std::string script_3_of_3_multisig =
    "3 [03dcfd9e580de35d8c2060d76dbf9e5561fe20febd2e64380e860a4d59f15ac864] "
    "[02440e0304bf8d32b2012994393c6a477acf238dd6adb4c3cef5bfa72f30c9861c] "
    "[03624505c6cc3967352cce480d8550490dd68519cd019066a4c302fdfb7d1c9934] 3 "
    "checkmultisig";
static const std::string script_4_of_3_multisig =
    "4 [03dcfd9e580de35d8c2060d76dbf9e5561fe20febd2e64380e860a4d59f15ac864] "
    "[02440e0304bf8d32b2012994393c6a477acf238dd6adb4c3cef5bfa72f30c9861c] "
    "[03624505c6cc3967352cce480d8550490dd68519cd019066a4c302fdfb7d1c9934] 3 "
    "checkmultisig";
...
class transaction_accessor : public transaction
{
public:
...
transaction_accessor test_tx(const script_test& test)
{
    ...
    const transaction_accessor tx{
        test.version, inputs{{point{}, in, test.input_sequence}}, outputs{},
        test.locktime};
...
std::string test_name(const script_test& test)
{
    ...
    out << "input: \"" << test.input << "\" "
        << "prevout: \"" << test.output << "\" "
        << "(" << test.input_sequence << ", " << test.locktime << ", "
        << test.version << ") "
    ...
    script__from_data__testnet_119058_invalid_op_codes__success)
{
    const auto data = base16_chunk(
        "0130323066643366303435313438356531306633383837363437356630643265396130"
        "3937393433323535343137666531393164386239636232306534306438633330303264"
        "3137346333653930636632343339323138376131303762363437333763393733313563"
        "3932393264653431373731636565613062323563633534353732653302ae");
...
{
    const auto data =
        base16_chunk("3045022100ff1fc58dbd608e5e05846a8e6b45a46ad49878aef6879ad"
                     "1a7cf4c5a7f853683022074a6a10f6053ab3cddc5620d169c7374cd42"
                     "c1416c51b9744db2c8d9febfb84d01");
...
{
    const auto normal_output_script =
        base16_chunk("76a91406ccef231c2db72526df9338894ccf9355e8f12188ac");
...
{
    const auto weird_raw_script =
        base16_chunk("0c49206c69656b20636174732e483045022100c7387f64e1f4"
...
{
    const auto raw =
        base16_chunk("76a914fc7b44566256621affb1541cc9d59f08336d276b88ac");
...
BOOST_AUTO_TEST_CASE(script__from_string__two_of_three_multisig__success)
{
    ...
    BOOST_REQUIRE_EQUAL(
        ops[1].to_string(forks::no_rules),
        "[03dcfd9e580de35d8c2060d76dbf9e5561fe20febd2e64380e860a4d59f15ac864]");
    BOOST_REQUIRE_EQUAL(
        ops[2].to_string(forks::no_rules),
        "[02440e0304bf8d32b2012994393c6a477acf238dd6adb4c3cef5bfa72f30c9861c]");
    BOOST_REQUIRE_EQUAL(
        ops[3].to_string(forks::no_rules),
        "[03624505c6cc3967352cce480d8550490dd68519cd019066a4c302fdfb7d1c9934]");
...
BOOST_AUTO_TEST_CASE(script__pattern__pay_null_data_return_only__non_standard)
{
    ...
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(
        instance.output_pattern() == chain::script_pattern::non_standard);
    BOOST_REQUIRE(
        instance.input_pattern() == chain::script_pattern::non_standard);
...
BOOST_AUTO_TEST_CASE(script__pattern__pay_null_data_empty__null_data)
{
    ...
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(
        instance.output_pattern() == chain::script_pattern::pay_null_data);
    BOOST_REQUIRE(
        instance.input_pattern() == chain::script_pattern::non_standard);
...
BOOST_AUTO_TEST_CASE(script__pattern__1_of_3_multisig__pay_multisig)
{
    ...
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(
        instance.output_pattern() == chain::script_pattern::pay_multisig);
    BOOST_REQUIRE(
        instance.input_pattern() == chain::script_pattern::non_standard);
...
BOOST_AUTO_TEST_CASE(script__bip16__valid)
{
    for (const auto& test : valid_bip16_scripts)
    {
        ...
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::no_rules}, 0) == error::script_success, name);
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::bip16_rule}, 0) == error::script_success, name);
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::all_rules}, 0) == error::script_success, name);
    }
}
...
BOOST_AUTO_TEST_CASE(script__bip65__valid)
{
    for (const auto& test : valid_bip65_scripts)
    {
        ...
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::no_rules}, 0) == error::script_success, name);
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::bip65_rule}, 0) == error::script_success, name);
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::all_rules & ~forks::bip112_rule}, 0)
...
BOOST_AUTO_TEST_CASE(script__multisig__valid)
{
    for (const auto& test : valid_multisig_scripts)
    {
        ...
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::no_rules}, 0) == error::script_success, name);
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::bip66_rule}, 0) == error::script_success, name);
        BOOST_CHECK_MESSAGE(
            tx.connect({forks::all_rules}, 0) == error::script_success, name);
    }
}
...
BOOST_AUTO_TEST_CASE(script__verify__testnet_block_23428_multisig_tx__success)
{
    ...
    static const auto forks =
        ////forks::difficult |
        forks::retarget | forks::bip16_rule | forks::bip30_rule |
        ////forks::bip34_rule |
        ////forks::bip66_rule |
        forks::bip65_rule | // bip65 should be superseded by bip90.
        forks::bip90_rule;

    static const auto index = 1u;
    const auto decoded_tx = base16_chunk(
        "0100000002c0cd5346700d18a937575424eb84888bdc277bdbfade39b3bb9a4ce31fd4"
        "455101000000fdf60100483045022100f681bb660ef85bb191e337450f2ba3493c37b9"
        "0a8622864d932cec5b40a74428022007cab269d846b7e63899b8e7082bdea94375d4b1"
        "c197b7c50365823c9ffd935e01483045022100b4d3be95b088c8ef176b25c9cee0b16a"
        "c7f91c10ccf645ab7421ad3de1d8aba802205c6b3bd9df0b19271abefc47997ce7bd11"
        "3a6f069674003c821c01440d49a48b0148304502207fad219634211fb614cef1654bdb"
        "956a9ed751a352e47c2b64d4ac8459e05ec2022100bd4ae53e76f266938f2ec09d1b2d"
        "515eaf5e21b990e5c7df0779ca61f24a10de014830450221009f2dd7fa5eafdf9f660e"
        "764750aabffd86628bb19501d49007551151f6409266022019fad776d46c6896a849bf"
        "7fcacefa73da6d5db22680c7bacdd055d8d8547858014ccf542102d7dafdc7f5d63bc1"
        "e5210a93a93c57e96acfb123df06ca02318be689791fa634210204affb8e9fd6228d37"
        "0aed6b8fff2fc33bbe9603e2933ae3b92b11a67d7e7d3d210269fa9a07b38c01440eca"
        "bc74481fdd2ede1591e293a1108ba1ac511d85e40ca62102f24bda0faab218a98c5975"
        "cb7eb035b37020ec3758e454d95f382e1f274da2112102795716e51a5539961872b559"
        "f2e938a29862565c1d0c70ed6a748adb8541c82b2103828209539e87cc72694e0d397a"
        "00ae1c1b3aa3aa7931df3bb72c71172758ed7756aeffffffffca1ea035fedd045da687"
        "f8219f6d76982b47fd3edab01212d3def0dc917d321801000000fdf401004730440220"
        "50cf9d0bf024af1780af7ce91a8cac62fd54a3df96cc1eb27889a58aaf82f09e02205f"
        "85c010faa5978963f569cfa6bd7202363841ad82bab0a6044c1092140ba49001483045"
        "022100f3f5076e1f233acf3fd2bb1188da82f3259224ee29a50af287b707c71503543f"
        "02202e82db849e59f8eb836ec6c55dab6a3d61b6511e9d25e550901d55342764323201"
        "48304502210094ff0cd6c74dd756a07334c2b76373dd4fb8f5ef7c1da7e09a168d54cf"
        "79a7770220114337de0ac0edd7871c079b796ad422d2d5e50d350d3b9f7371b0f1bd66"
        "fe7a01473044022022bc92872b6c680da40aa6388e28ef396c7ffa410317ae574c1f31"
        "836c85b28602203b43a7d2cdcc2ba1afaf53c1a0c0b474933581b0e359aed788ad7ad8"
        "19260dfb014ccf542102d7dafdc7f5d63bc1e5210a93a93c57e96acfb123df06ca0231"
        "8be689791fa634210204affb8e9fd6228d370aed6b8fff2fc33bbe9603e2933ae3b92b"
        "11a67d7e7d3d210269fa9a07b38c01440ecabc74481fdd2ede1591e293a1108ba1ac51"
        "1d85e40ca62102f24bda0faab218a98c5975cb7eb035b37020ec3758e454d95f382e1f"
        "274da2112102795716e51a5539961872b559f2e938a29862565c1d0c70ed6a748adb85"
        "41c82b2103828209539e87cc72694e0d397a00ae1c1b3aa3aa7931df3bb72c71172758"
        "ed7756aeffffffff02605af405000000001976a914bb6754a948265de730c60fbd745a"
        "eb5868ea921e88ac00e1f5050000000017a9144aba54e2541475f91659ccdbb13ce0b4"
        "90778c7f8700000000");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE(tx.is_valid());
    BOOST_REQUIRE_GT(tx.inputs()->size(), index);

    static const auto value = 100000000u;
    (*tx.inputs())[index]->prevout.reset(new prevout{
        value,
        {base16_chunk("a9144aba54e2541475f91659ccdbb13ce0b490778c7f87"),
         false}});
...
BOOST_AUTO_TEST_CASE(script__verify__block_290329_tx__success)
{
    ...
    static const auto index = 1u;
    const auto decoded_tx = base16_chunk(
        "0100000002f9cbafc519425637ba4227f8d0a0b7160b4e65168193d5af39747891de98"
        "b5b5000000006b4830450221008dd619c563e527c47d9bd53534a770b102e40faa87f6"
        "1433580e04e271ef2f960220029886434e18122b53d5decd25f1f4acb2480659fea20a"
        "abd856987ba3c3907e0121022b78b756e2258af13779c1a1f37ea6800259716ca4b7f0"
        "b87610e0bf3ab52a01ffffffff42e7988254800876b69f24676b3e0205b77be476512c"
        "a4d970707dd5c60598ab00000000fd260100483045022015bd0139bcccf990a6af6ec5"
        "c1c52ed8222e03a0d51c334df139968525d2fcd20221009f9efe325476eb64c3958e47"
        "13e9eefe49bf1d820ed58d2112721b134e2a1a53034930460221008431bdfa72bc67f9"
        "d41fe72e94c88fb8f359ffa30b33c72c121c5a877d922e1002210089ef5fc22dd8bfc6"
        "bf9ffdb01a9862d27687d424d1fefbab9e9c7176844a187a014c9052483045022015bd"
        "0139bcccf990a6af6ec5c1c52ed8222e03a0d51c334df139968525d2fcd20221009f9e"
        "fe325476eb64c3958e4713e9eefe49bf1d820ed58d2112721b134e2a1a5303210378d4"
        "30274f8c5ec1321338151e9f27f4c676a008bdf8638d07c0b6be9ab35c71210378d430"
        "274f8c5ec1321338151e9f27f4c676a008bdf8638d07c0b6be9ab35c7153aeffffffff"
        "01a08601000000000017a914d8dacdadb7462ae15cd906f1878706d0da8660e6870000"
        "0000");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE(tx.is_valid());
    BOOST_REQUIRE_GT(tx.inputs()->size(), index);

    static const auto value = 0u;
    (*tx.inputs())[index]->prevout.reset(new prevout{
        value,
        {base16_chunk("a914d8dacdadb7462ae15cd906f1878706d0da8660e687"),
         false}});
    BOOST_REQUIRE_EQUAL(tx.connect({forks}, index), error::script_success);
}
...
BOOST_AUTO_TEST_CASE(script__verify__block_438513_tx__success)
{
    ...
    // Flag bit 0 was reversed from easy to difficult, for mainnet consistency.
    static const auto forks =
        forks::difficult | forks::retarget |
        ////forks::bip16_rule | // This looks wrong.
        ////forks::bip30_rule | // This is moot but looks wrong.
        forks::bip34_rule | forks::bip66_rule;

    static const auto index = 0u;
    const auto decoded_tx = base16_chunk(
        "0100000001a06bf74cc36eac395188b06850c5a01d00b355065c589d14036e89e075d7"
        "518e000000009d483045022100ba555ac17a084e2a1b621c2171fa563bc4fb75cd5c09"
        "68153f44ba7203cb876f022036626f4579de16e3ad160df01f649ffb8dbf47b504ee56"
        "dc3ad7260af24ca0db0101004c50632102768e47607c52e581595711e27faffa7cb646"
        "b4f481fe269bd49691b2fbc12106ad6704355e2658b1756821028a5af8284a12848d69"
        "a25a0ac5cea20be905848eb645fd03d3b065df88a9117cacfeffffff01589201000000"
        "00001976a9149d86f66406d316d44d58cbf90d71179dd8162dd388ac355e2658");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE(tx.is_valid());
    BOOST_REQUIRE_GT(tx.inputs()->size(), index);
    ...
    (*tx.inputs())[index]->prevout.reset(new prevout{
        value,
        {base16_chunk("a914faa558780a5767f9e3be14992a578fc1cbcf483087"),
         false}});
    BOOST_REQUIRE_EQUAL(tx.connect({forks}, index), error::script_success);
}
...
BOOST_AUTO_TEST_CASE(script__verify__block_481824_tx__success)
{
    ...
    // Flag bit 0 was reversed from easy to difficult, for mainnet consistency.
    static const auto forks =
        forks::difficult | forks::retarget | forks::bip16_rule
        | forks::bip30_rule | forks::bip34_rule | forks::bip66_rule
        | forks::bip65_rule | forks::bip90_rule | forks::bip68_rule
        | forks::bip112_rule | forks::bip113_rule | forks::bip141_rule
        | forks::bip143_rule | forks::bip147_rule;

    static const auto index = 0u;
    const auto decoded_tx = base16_chunk(
        "0200000000010140d43a99926d43eb0e619bf0b3d83b4a31f60c176beecfb9d35bf45e"
        "54d0f7420100000017160014a4b4ca48de0b3fffc15404a1acdc8dbaae226955ffffff"
        "ff0100e1f5050000000017a9144a1154d50b03292b3024370901711946cb7cccc38702"
        "4830450221008604ef8f6d8afa892dee0f31259b6ce02dd70c545cfcfed81481799718"
        "76c54a022076d771d6e91bed212783c9b06e0de600fab2d518fad6f15a2b191d7fbd26"
        "2a3e0121039d25ab79f41f75ceaf882411fd41fa670a4c672c23ffaf0e361a969cde06"
        "92e800000000");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE(tx.is_valid());
    BOOST_REQUIRE_GT(tx.inputs()->size(), index);
    ...
    (*tx.inputs())[index]->prevout.reset(new prevout{
        value,
        {base16_chunk("a9142928f43af18d2d60e8a843540d8086b30534133987"),
         false}});
    BOOST_REQUIRE_EQUAL(tx.connect({forks}, index), error::script_success);
}

BOOST_AUTO_TEST_CASE(
    script__verify__testnet_block_892321_tx_missing_witness__invalid_witness)
{
    ...
    static const auto forks =
        ////forks::difficult |
        forks::retarget | forks::bip16_rule | forks::bip30_rule
        | forks::bip34_rule | forks::bip66_rule | forks::bip65_rule
        | forks::bip90_rule | forks::bip68_rule | forks::bip112_rule
        | forks::bip113_rule | forks::bip141_rule | forks::bip143_rule
        | forks::bip147_rule;

    static const auto index = 0u;
    const auto decoded_tx =
        base16_chunk("0200000001f508cd3a9902906e2101a0632e937284bf6cfe8d263052f"
                     "40152ced6f5e8a5fc0000000000ffffffff0105e40200000000001600"
                     "14b6aa463696df9140b1191fa2cc1891cf9b5da6d900000000");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE(tx.is_valid());
    BOOST_REQUIRE_GT(tx.inputs()->size(), index);
    BOOST_REQUIRE((*tx.inputs())[index]->witness().stack().empty());

    static const auto value = 194445u;
    (*tx.inputs())[index]->prevout.reset(new prevout{
        value,
        {base16_chunk("0020925fe0a6cde95bdc7a21b08925c246cae17005f8a013efffdb5e"
                      "5cb7b7f8d0c2"),
         false}});
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_native_p2wpkh_tx__success)
{
    ...
    BOOST_REQUIRE((*tx.inputs())[0]->witness().stack().empty());
    BOOST_REQUIRE(!(*tx.inputs())[1]->witness().stack().empty());

    const auto value0 = 625000000u;
    (*tx.inputs())[0]->prevout.reset(new prevout{
        value0,
        {base16_chunk("2103c9f4836b9a4f77fc0d81f7bcb01b7f1b35916864b9476c241ce9"
                      "fc198bd25432ac"),
         false}});

    const auto value1 = 600000000u;
    (*tx.inputs())[1]->prevout.reset(new prevout{
        value1,
        {base16_chunk("00141d0f172a0ecb48aee1be1f2687d2963ae33f71a1"), false}});

    // ordinary P2PK (no rules required).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::no_rules}, 0), error::script_success);

    // P2WPKH witness program.
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip141_rule | forks::bip143_rule}, 1),
        error::script_success);
    ...
    // extra rules (okay).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip141_rule | forks::bip143_rule}, 0),
        error::script_success);

    // missing bip143 (invalid sighash).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip141_rule}, 1), error::stack_false);

    // missing bip141 (witness not allowed).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip143_rule}, 1), error::unexpected_witness);

    // missing bip141 (witness not allowed).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::no_rules}, 1), error::unexpected_witness);
}
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_p2sh_p2wpkh_tx__success)
{
    ...
    const auto value = 1000000000u;
    (*tx.inputs())[0]->prevout.reset(new prevout{
        value,
        {base16_chunk("a9144733f37cf4db86fbc2efed2500b4f4e49f31202387"),
         false}});

    // P2SH-P2WPKH witness program.
    BOOST_REQUIRE_EQUAL(
        tx.connect(
            {forks::bip16_rule | forks::bip141_rule | forks::bip143_rule}, 0),
        error::script_success);
    ...
    // missing bip141 (witness not allowed).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip16_rule | forks::bip143_rule}, 0),
        error::unexpected_witness);

    // missing bip143 (invalid sighash).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip16_rule | forks::bip141_rule}, 0),
        error::stack_false);
}
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_native_p2wsh_1_tx__success)
{
    ...
    const auto value0 = 156250000u;
    (*tx.inputs())[0]->prevout.reset(new prevout{
        value0,
        {base16_chunk("21036d5c20fa14fb2f635474c1dc4ef5909d4568e5569b79fc94d344"
                      "8486e14685f8ac"),
         false}});

    const auto value1 = 4900000000u;
    (*tx.inputs())[1]->prevout.reset(new prevout{
        value1,
        {base16_chunk("00205d1b56b63d714eebe542309525f484b7e9d6f686b3781b6f61ef"
                      "925d66d6f6a0"),
         false}});
    ...
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip141_rule}, 1), error::op_check_sig_verify5);
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_native_p2wsh_2_tx__success)
{
    ...
    const auto value0 = 16777215u;
    (*tx.inputs())[0]->prevout.reset(new prevout{
        value0,
        {base16_chunk("0020ba468eea561b26301e4cf69fa34bde4ad60c81e70f059f045ca9"
                      "a79931004a4d"),
         false}});
    ...
    (*tx.inputs())[1]->prevout.reset(new prevout{
        value1,
        {base16_chunk("0020d9bbfbe56af7c4b7f960a70d7ea107156913d9e5a26b0a71429d"
                      "f5e097ca6537"),
         false}});
    ...
    // all inputs
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip141_rule | forks::bip143_rule}),
        error::transaction_success);
    ...
    BOOST_REQUIRE_EQUAL(
        tx.connect(
            {forks::bip16_rule | forks::bip141_rule | forks::bip143_rule}, 1),
        error::script_success);

    // missing bip143 (code-separator treatment).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip141_rule}, 0), error::stack_false);
    ...
    // missing bip141 (witness not allowed).
    BOOST_REQUIRE_EQUAL(
        tx.connect({forks::bip143_rule}, 0), error::unexpected_witness);
...
{
    const auto decoded_tx = base16_chunk(
        "0100000000010280e68831516392fcd100d186b3c2c7b95c80b53c77e77c35ba03a66b"
        "429a2a1b0000000000ffffffffe9b542c5176808107ff1df906f46bb1f2583b16112b9"
        "5ee5380665ba7fcfc0010000000000ffffffff0280969800000000001976a9146648a8"
        "cd4531e1ec47f35916de8e259237294d1e88ac80969800000000001976a914de4b2316"
        "26ef508c9a74a8517e6783c0546d6b2888ac024730440220032521802a76ad7bf74d0e"
        "2c218b72cf0cbc867066e2e53db905ba37f130397e02207709e2188ed7f08f4c952d9d"
        "13986da504502b8c3be59617e043552f506c46ff83275163ab68210392972e2eb617b2"
        "388771abe27235fd5ac44af8e61693261550447a4c3e39da98ac02483045022100f6a1"
        "0b8604e6dc910194b79ccfc93e1bc0ec7c03453caaa8987f7d6c341356600220621622"
        "9ede9b4d6ec2d325be245c5b508ff0339bf1794078e20bfe0babc7ffe683270063ab68"
        "210392972e2eb617b2388771abe27235fd5ac44af8e61693261550447a4c3e39da98ac"
        "00000000");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE_EQUAL(tx.inputs()->size(), 2u);
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_p2sh_p2wsh_tx__success)
{
    ...
    const auto value0 = 987654321u;
    (*tx.inputs())[0]->prevout.reset(new prevout{
        value0,
        {base16_chunk("a9149993a429037b5d912407a71c252019287b8d27a587"),
         false}});
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_no_find_and_delete_tx__success)
{
    const auto decoded_tx = base16_chunk(
        ...
        "5feb48f845d5bfc9882eb6aeefa1bc3790e39f59eaa46ff7f15ae626c53e010000000"
        "0");
    const transaction_accessor tx(decoded_tx, true);
    BOOST_REQUIRE(tx.is_valid());
    BOOST_REQUIRE_EQUAL(tx.inputs()->size(), 1u);
    ...
    const auto value0 = 200000u;
    (*tx.inputs())[0]->prevout.reset(new prevout{
        value0,
        {base16_chunk("00209e1be07558ea5cc8e02ed1d80c0911048afad949affa36d5c395"
                      "1e3159dbea19"),
         false}});
    ...
    BOOST_REQUIRE_EQUAL(
        tx.connect(
            {forks::bip141_rule | forks::bip143_rule | forks::bip147_rule}, 0),
        error::script_success);
...
{
    const std::string text{"\"pick roll return\""};

    const chain::script instance{
        chain::operations{{opcode::pick}, {opcode::roll}, {opcode::op_return}}};
