...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_size_0, forks::no_rules) == "zero");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_size_0, forks::all_rules) == "zero");
}

// We formerly serialized all 1-75 as 'special'.
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__push_size_42_any_forks__push_42)
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_size_42, forks::no_rules) == "push_42");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_size_42, forks::all_rules)
        == "push_42");
}

// Use the traditional serializations for all codes (in this case 'pushdata1' vs. 'push_one').
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__push_one_size_any_forks__pushdata1)
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_one_size, forks::no_rules)
        == "pushdata1");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_one_size, forks::all_rules)
        == "pushdata1");
}

// Use the traditional serializations for all codes (in this case 'pushdata2' vs. 'push_two').
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__push_two_size_size_any_forks__pushdata2)
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_two_size, forks::no_rules)
        == "pushdata2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_two_size, forks::all_rules)
        == "pushdata2");
}

// Use the traditional serializations for all codes (in this case 'pushdata4' vs. 'push_four').
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__push_four_size_any_forks__pushdata4)
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_four_size, forks::no_rules)
        == "pushdata4");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_four_size, forks::all_rules)
        == "pushdata4");
}

// Use the traditional serializations for all codes (in this case 'reserved' vs. 0x50).
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__reserved_80_any_forks__reserved)
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::reserved_80, forks::no_rules) == "reserved");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::reserved_80, forks::all_rules)
        == "reserved");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_positive_7, forks::no_rules) == "7");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::push_positive_7, forks::all_rules) == "7");
}
...
BOOST_AUTO_TEST_CASE(opcode__opcode_to_mnemonic__op_ver_any_forks__ver)
{
    ...
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::op_ver, forks::all_rules) == "ver");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::op_verif, forks::no_rules) == "verif");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::op_verif, forks::all_rules) == "verif");
}

// Use the traditional serializations for all codes (in this case 'vernotif' vs. '0x66').
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__op_vernotif_any_forks__vernotif)
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::op_vernotif, forks::no_rules) == "vernotif");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::op_vernotif, forks::all_rules)
        == "vernotif");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::drop2, forks::no_rules) == "2drop");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::drop2, forks::all_rules) == "2drop");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::over2, forks::no_rules) == "2over");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::over2, forks::all_rules) == "2over");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::swap2, forks::no_rules) == "2swap");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::swap2, forks::all_rules) == "2swap");
}
...
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__nop2_or_checklocktimeverify_any_fork_except_bip65__nop2)
{
    ...
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip16_rule) == "nop2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip30_rule) == "nop2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip34_rule) == "nop2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip42_rule) == "nop2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip66_rule) == "nop2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip112_rule) == "nop2");
}

// Ensure nop2 and checklocktimeverify serialize as 'checklocktimeverify' with bip65 fork.
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__nop2_or_checklocktimeverify_bip65_fork__checklocktimeverify)
{
    static_assert(opcode::checklocktimeverify == opcode::nop2, "nop2 drift");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip65_rule)
        == "checklocktimeverify");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::all_rules)
        == "checklocktimeverify");
}

// Ensure nop3 still serializes as 'nop3' without bip112 fork.
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__nop3_or_checksequenceverify_any_fork_except_bip112__nop3)
{
    ...
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::bip16_rule) == "nop3");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::bip30_rule) == "nop3");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::bip34_rule) == "nop3");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop2, forks::bip42_rule) == "nop2");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::bip66_rule) == "nop3");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::bip65_rule) == "nop3");
}

// Ensure nop3 and checksequenceverify serialize as 'checksequenceverify' with bip112 fork.
BOOST_AUTO_TEST_CASE(
    opcode__opcode_to_mnemonic__nop3_or_checksequenceverify_bip112_fork__checksequenceverify)
{
    static_assert(opcode::checksequenceverify == opcode::nop3, "nop3 drift");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::bip112_rule)
        == "checksequenceverify");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::nop3, forks::all_rules)
        == "checksequenceverify");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::reserved_186, forks::no_rules) == "0xba");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::reserved_186, forks::all_rules) == "0xba");
}
...
{
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::reserved_255, forks::no_rules) == "0xff");
    BOOST_REQUIRE(
        opcode_to_mnemonic(opcode::reserved_255, forks::all_rules) == "0xff");
}
...
BOOST_AUTO_TEST_CASE(
    opcode__opcode_from_mnemonic__checklocktimeverify__nop2_or_checklocktimeverify)
{
    static_assert(opcode::checklocktimeverify == opcode::nop2, "nop2 drift");
    opcode out_code;
...
BOOST_AUTO_TEST_CASE(
    opcode__opcode_from_mnemonic__checksequenceverify__nop3_or_checksequenceverify)
{
    static_assert(opcode::checksequenceverify == opcode::nop3, "nop3 drift");
    opcode out_code;
